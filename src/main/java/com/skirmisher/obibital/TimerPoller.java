...
public class TimerPoller implements Runnable{
    ...
    public void run(){
        try{
            ...
            System.out.println("Timer Poller:: Found " + expiredTimers.size() + " expired timers");
    ...
    public void unBan(String[] args){
        ...
        try{
            boolean success = bot.execute(unban);
            if(success){
                System.out.println("SUCCESFUL UNBAN YAY");
            }
        ...
        userMessage.setText("You have been unbanned from " + "CHAT NAME"); //TODO: make this generic  
